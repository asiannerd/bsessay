...
quote_start = ["it is infact appropriate to bring in a quote: ",
               "what this person said about " + topic + " is infact very true: ",
               "a good action is to examine are quotes about " + topic + " like this one: ",
               "to answer all the questions about " + topic + " a good quote is: ",
               "the wise had said something: ",
...
while True:
    if times < 20:
        print(starters[randint(0,20)] + semistarters[randint(0,25)] +"\n"+ quote_start[randint(0,21)]  + quotes[randint(0,19)] + "\n" + conjunctions[randint(0,20)] + ideas[randint(0,20)] + topic + ".\n" + conclusions[randint(0,19)])
        times = times + 1
